...
export const metadata: Metadata = {
  title: "Tablero 1 · Leyes UX — MiBarco.Online",
  description:
    "Evaluación de MiBarco.Online contra 14 leyes UX, con captura y explicación por ley.",
};
